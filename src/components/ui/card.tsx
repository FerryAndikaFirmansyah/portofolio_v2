...
const Card = ({ title, description, image, link, tech }: CardProps) => {
  return (
    <StyledWrapper>
          ...
          <div className="canvas">
            ...
            <div id="card">
              <div className="card-content">
                ...
                {/* TITLE */}
                <div className="title font-semibold py-15 text-center text-2xl">
                  {title}
                </div>
                ...
                {/* TECH */}
                <p className="text-xs text-cyan-400 mt-2 text-center">{tech}</p>
              </div>
            </div>
          </div>
        </div>
